## Fork info
Image with SQLite journal mode set to Truncate by default. 

Built against Radarr master branch.

### Image name
```
sruon/linuxserver-radarr-truncate-mode
```
https://hub.docker.com/r/sruon/linuxserver-radarr-truncate-mode
